...
const AttachModal = ({ name, labelClass, ...attributes }) => {
    ...
    const btnClassName = " btn btn-warning px-4 shadow-sm rounded-pill ms-3 " + (labelClass ? labelClass : "")
    const labelClassName = "d-lg-none flex-center p-0 btn btn-warning shadow-sm rounded-circle ms-2 " + (labelClass ? labelClass : "")
    const labelClassNameLg = "d-none d-lg-block btn btn-warning px-4 shadow-sm rounded-pill ms-3 " + (labelClass ? labelClass : "")
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            {
                                file &&
                                <div className='mt-3 p-2 bg-warning border rounded-3 shadow-sm text-primary d-flex align-items-center'>
                                    {Icons.addImage("me-2 ")}
                                    {file.name}
