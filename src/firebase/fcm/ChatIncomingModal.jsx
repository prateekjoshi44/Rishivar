...
const ChatIncomingModal = ({ id }) => {
  ...
  const handleActiveChat = async () => {
    await patchChatStatus({ id, status: "Active" })
          ...
          <div className="modal-content">
            ...
            <div className="modal-footer">
              <>
                ...
                <Button res={patchChatStatusRes} data-bs-dismiss="modal" onClick={() => patchChatStatus({ id, status: "UserRejected" })} color={"danger"}>Reject</Button>
              </>
            </div>
          </div>
        </div>
